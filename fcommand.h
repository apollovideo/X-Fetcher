...
#ifdef DVRS_BASKET_FS
#define IDENTIFIER                   0x00002818
#else
#define PACKET_IDENTIFIER            0x00002818
#endif

#define BEACON_STATUS_PACKET_ID      0xA5A52011
#define BEACON_STATUSADD_PACKET_ID   0xA5A5DFEE

#define MCU_INTROMAGIC               0x67200672

#define CMD_INTROREQUEST             0x0001
#define CMD_INTROPACKET              0x0002
#define CMD_STATICINSERT             0x0004
...
#define CMD_VSTREAM_DATA             0x4004 ///< video stream data
#define CMD_VSTREAM_STOP             0x4005
#define CMD_VSTREAM_FRAME            0x4006 ///< StreamFrameHeader_t is following after COMMON_PACKET_HEADER: new video frame data with better structure than CMD_VSTREAM_DATA Goe 2013-12-11
...
#define CMD_AOUT_REQ                 0x4031   // 11�� 11�� �߰�
